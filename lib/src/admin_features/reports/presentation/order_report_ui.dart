...
class OrderReportUi extends ConsumerStatefulWidget {
  const OrderReportUi({super.key});

  @override
  ConsumerState<OrderReportUi> createState() => _OrderReportUiState();
}

class _OrderReportUiState extends ConsumerState<OrderReportUi> {
            ...
            child: Column(
              ...
              children: [
                ...
                CustomButton(
                  ...
                  onPressed: () async {
                    final orderService =
                        ref.watch(orderServiceProvider.notifier);
                    ...
                    final String? url = await orderService.getPdfOrders(
                        body: OrderPdfModel(
