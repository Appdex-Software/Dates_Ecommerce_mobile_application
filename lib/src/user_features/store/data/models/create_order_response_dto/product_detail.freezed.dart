...
abstract class $ProductDetailCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? id, num? quantity, String? product});
}
...
class _$ProductDetailImpl implements _ProductDetail {
  _$ProductDetailImpl({this.id, this.quantity, this.product});
  ...
  @override
  String toString() {
    return 'ProductDetail(id: $id, quantity: $quantity, product: $product)';
  }
