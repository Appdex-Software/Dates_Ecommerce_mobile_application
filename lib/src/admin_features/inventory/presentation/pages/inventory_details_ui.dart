                ...
                child: ListView(
                      ...
                      children: [
                        ...
                        CustomTextField(
                          ...
                          validator: (p0) {
                            final result =(int.parse(totalQuantityController.text) < (int.parse(familyQuantityController.text) + int.parse(charitiesQantityController.text) + int.parse(fastingQuantityController.text)));
                            if(totalQuantityController.text.isEmpty) {
                              return l10n.emptyValidationError;
                            } else if (result) {
                              return l10n.theSumOfFamiliesQuantityFastingQuantityAndCharitiesQuantityMustBeLessThanOrEqualToTotalQuantity;
                            }
                            return null;
                          },
                          onChanged: (p0) {
