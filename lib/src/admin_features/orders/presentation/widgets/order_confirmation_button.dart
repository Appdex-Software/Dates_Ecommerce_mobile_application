...
class OrderConfirmationButton extends ConsumerStatefulWidget {
  const OrderConfirmationButton(
      {required this.onTap, required this.data, this.currentState, super.key});
  final OrderUserData? data;
  final String? currentState;
  final void Function()? onTap;
  @override
  ConsumerState<OrderConfirmationButton> createState() =>
      _OrderConfirmationButtonState();
}

class _OrderConfirmationButtonState
    extends ConsumerState<OrderConfirmationButton> {
  @override
